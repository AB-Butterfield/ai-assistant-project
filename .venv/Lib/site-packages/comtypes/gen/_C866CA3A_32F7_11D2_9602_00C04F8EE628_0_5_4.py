...
__all__ = [
    'DISPID_SRCSetAdaptationData', 'DISPID_SPRuleId',
    'ISpeechResourceLoader', 'DISPID_SVSLastStreamNumberQueued',
    'SpCompressedLexicon', 'SP_VISEME_11',
    'DISPID_SOTMatchesAttributes', 'DISPID_SPERequiredConfidence',
    'DISPID_SVRate', 'ISpeechAudio', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SLPSymbolic', 'SAFT22kHz8BitStereo', 'eLEXTYPE_PRIVATE1',
    'DISPID_SVIsUISupported', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRRTStreamTime', 'SPSMF_SRGS_SAPIPROPERTIES',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechTokenKeyFiles',
    'SAFT48kHz16BitStereo', 'DISPID_SPCLangId', 'ISpDataKey',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SPIReplacements',
    'DISPID_SPRDisplayAttributes', 'SRESoundEnd', 'SSFMOpenForRead',
    'SAFTNoAssignedFormat', 'SAFT11kHz8BitStereo',
    'DISPID_SPISaveToMemory', 'SVPOver', 'SINoSignal',
    'SECNormalConfidence', 'DISPID_SRRRecoContext',
    'DISPID_SPRsCount', 'DISPID_SGRAttributes', 'SVP_0',
    'DISPID_SLAddPronunciation', 'SAFTGSM610_44kHzMono', 'SPVISEMES',
    'SFTInput', 'SAFTADPCM_8kHzStereo', 'DISPID_SDKSetLongValue',
    'SPLEXICONTYPE', 'SP_VISEME_7', 'DISPID_SGRClear',
    'DISPID_SPPFirstElement', 'SPEVENT', 'SAFTGSM610_11kHzMono',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SpeechPhraseInfo',
    'SVP_9', 'SPAR_Medium', 'DISPID_SPEAudioSizeTime', 'SVP_17',
    'DISPID_SVGetAudioOutputs', 'SpeechEngineProperties',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SPPNumberOfElements',
    'SREPrivate', 'DISPID_SPCIdToPhone', 'SP_VISEME_6',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SRADefaultToActive',
    'ISpProperties', 'ISpShortcut', 'SAFTADPCM_44kHzMono',
    'SGSEnabled', 'DISPID_SRProfile', 'SPCT_SLEEP', 'SECFIgnoreCase',
    'DISPID_SRCVoicePurgeEvent', 'SPRULESTATE', 'DISPID_SOTSetId',
    'SPEI_SR_RETAINEDAUDIO', 'ISpAudio', 'SpMMAudioEnum',
    'SPRECORESULTTIMES', 'SpMMAudioIn', 'ISpRecoContext',
    'SPPS_NotOverriden', 'DISPID_SPRulesItem', 'SP_VISEME_16',
    'DISPID_SVAudioOutputStream', 'DISPID_SVGetVoices',
    'DISPID_SOTRemoveStorageFileName',
    'DISPID_SRCRetainedAudioFormat', 'SVP_4',
    'DISPID_SABufferNotifySize', 'DISPID_SPRText',
    'DISPID_SpeechRecognizer', 'SPWORDPRONUNCIATION',
    'DISPID_SGRsCount', 'SDKLCurrentUser', 'DISPID_SRGRules',
    'DISPID_SVSLastBookmarkId', 'SREPropertyStringChange',
    'SREAdaptation', 'SP_VISEME_1', 'SPAR_Low', 'SREFalseRecognition',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRGIsPronounceable', 'SAFT24kHz16BitStereo',
    'SAFTCCITT_uLaw_11kHzMono', 'SpeechTokenShellFolder',
    'SAFTADPCM_8kHzMono', 'DISPID_SMSAMMHandle', 'ISpLexicon',
    'SPEI_SR_PRIVATE', 'DISPID_SPPsItem', 'DISPID_SDKSetBinaryValue',
    'SDTReplacement', 'SAFT32kHz16BitMono', 'DISPID_SPACommit',
    'DISPID_SpeechVoiceEvent', 'SPCT_COMMAND', 'ISpeechCustomStream',
    'SpeechCategoryAudioOut', 'DISPID_SRGetPropertyString',
    'DISPID_SOTGetAttribute', 'SRTEmulated',
    'DISPID_SPIGetDisplayAttributes', 'SGDSInactive',
    'DISPID_SPIRule', 'ISpVoice', 'DISPID_SGRSTPropertyValue',
    'SASClosed', 'SVP_19', 'ISpRecognizer',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpeechRecoResult2',
    'SSSPTRelativeToEnd', 'SpeechRecognitionType',
    'SAFTADPCM_44kHzStereo', 'SP_VISEME_18', 'SPPS_RESERVED1',
    'DISPID_SGRSTText', 'SSFMCreateForWrite', 'SPEI_ADAPTATION',
    'DISPID_SPAPhraseInfo',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechVoiceCategoryTTSRate', 'SpeechTokenContext',
    'SPEI_HYPOTHESIS', 'SPEI_FALSE_RECOGNITION', 'eLEXTYPE_PRIVATE11',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SBSFormat',
    'DISPID_SPRuleNumberOfElements', 'DISPIDSPTSI',
    'ISpeechRecoResultTimes', 'SPCT_SUB_COMMAND', 'SPWT_LEXICAL',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SPRs_NewEnum', 'ISpeechVoice', 'SAFT44kHz16BitMono',
    'SPCATEGORYTYPE', 'SPEI_PROPERTY_STRING_CHANGE',
    'SECFIgnoreWidth', 'SpMMAudioOut', 'DISPID_SOTCreateInstance',
    'DISPID_SpeechLexicon', 'DISPID_SRGCmdLoadFromFile',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SBSSeek',
    'ISpeechRecoResult', 'SpeechAudioFormatGUIDText', 'DISPIDSPRG',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SGRSAddSpecialTransition', 'SAFTCCITT_ALaw_11kHzMono',
    'SpeechCategoryRecoProfiles', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechPropertyNormalConfidenceThreshold',
    'SpeechTokenKeyAttributes', 'DISPID_SPPParent',
    'ISpeechFileStream', 'DISPID_SABufferInfo',
    'ISpeechAudioBufferInfo', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SpeechPhraseElements', 'SPBO_NONE', 'SP_VISEME_12',
    'SAFT32kHz8BitMono', 'SGLexical', 'SPAS_CLOSED',
    'ISpeechPhraseRule', 'ISpeechObjectToken', 'ISpPhoneConverter',
    'SpeechAudioFormatType', 'DISPID_SPPId', 'SPEI_WORD_BOUNDARY',
    'eLEXTYPE_PRIVATE15', 'DISPID_SOTsCount', 'SVP_7',
    'SPEI_END_SR_STREAM', 'SPSERIALIZEDRESULT', '_ISpeechVoiceEvents',
    'DISPID_SOTDataKey', 'DISPID_SVSInputWordPosition', 'SITooLoud',
    'DISPID_SPEDisplayAttributes', 'SpShortcut',
    'SpeechPropertyResponseSpeed', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SpeechPhraseProperty', 'SPDKL_LocalMachine',
    'SPEI_MAX_SR', 'SAFT12kHz8BitMono', 'SAFT12kHz16BitMono',
    'SDTPronunciation', 'SVSFlagsAsync', 'SVSFParseSsml',
    'SpeechEmulationCompareFlags', 'SRESoundStart',
    'DISPID_SVSLastResult', 'DISPID_SRRAlternates',
    'DISPID_SCSBaseStream', 'DISPID_SGRSTsCount',
    'ISpeechTextSelectionInformation',
    'SpeechGrammarTagUnlimitedDictation', 'SpeechLexiconType',
    'DISPID_SAEventHandle', 'SVPAlert', 'SAFTADPCM_11kHzStereo',
    'DISPID_SpeechFileStream', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SRRTTickCount',
    'SPINTERFERENCE_NONE', 'ISpRecoContext2', 'eLEXTYPE_USER',
    'DISPID_SASetState', '_RemotableHandle', 'SPEI_MIN_TTS',
    'SVSFVoiceMask', 'SpeechRunState', 'DISPID_SpeechRecoResult2',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPEPronunciation', 'SGDSActive',
    'DISPID_SPRules_NewEnum', 'SGRSTTRule', 'SpPhoneConverter',
    'SAFT12kHz8BitStereo', 'SPBO_PAUSE', 'ISpRecognizer3',
    'DISPID_SpeechObjectTokens', 'DISPID_SPRuleEngineConfidence',
    'SLODynamic', 'SpeechVisemeFeature', 'DISPID_SRGRecoContext',
    'SPTEXTSELECTIONINFO', 'DISPID_SOTRemove',
    'SpeechGrammarRuleStateTransitionType', 'SPEI_TTS_BOOKMARK',
    'DISPID_SMSGetData', 'Speech_Max_Word_Length', 'SVEViseme',
    'SRAImport', 'DISPID_SRState', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPPBRestorePhraseFromMemory',
    'SpeechEngineConfidence', 'DISPID_SRCRecognizer', 'SINoise',
    'DISPID_SRGReset', 'ISpeechGrammarRuleStateTransitions', 'SVP_11',
    'DISPID_SLRemovePronunciation', 'DISPID_SpeechGrammarRule',
    'SPWF_INPUT', 'SPSModifier', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SMSADeviceId', 'DISPID_SRRSetTextFeedback',
    'SVEWordBoundary', 'SPINTERFERENCE_TOOSLOW', 'SPVOICESTATUS',
    'SpeechCategoryVoices', 'ISpeechLexiconWord',
    'SAFTNonStandardFormat', 'DISPID_SRCState',
    'DISPID_SpeechRecognizerStatus', 'SpNullPhoneConverter',
    'SPPHRASERULE', 'DISPID_SDKEnumValues', 'DISPID_SVEStreamEnd',
    'SP_VISEME_3', 'DISPID_SRGCommit', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpeechTokenIdUserLexicon', 'ISpeechXMLRecoResult',
    'DISPID_SpeechXMLRecoResult', 'eLEXTYPE_PRIVATE3', 'SPAR_Unknown',
    'SBONone', 'DISPID_SPERetainedSizeBytes', 'SITooSlow',
    'SDA_Two_Trailing_Spaces', 'DISPID_SASCurrentSeekPosition',
    'SVEBookmark', 'DISPID_SPEEngineConfidence', 'SRATopLevel',
    'DISPID_SBSRead', 'SECFEmulateResult', 'SpeechRecoEvents',
    'DISPID_SPEAudioStreamOffset', 'SPEI_RECO_OTHER_CONTEXT',
    'SpeechSpecialTransitionType', 'SPWAVEFORMATTYPE',
    'DISPID_SVEStreamStart', 'DISPID_SABIBufferSize',
    'DISPID_SRRPhraseInfo', 'DISPID_SGRSTPropertyId',
    'SECFNoSpecialChars', 'ISpeechLexiconPronunciation',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRSSupportedLanguages',
    'SPSHT_Unknown', 'SPRULE', 'SPEI_UNDEFINED', 'SASRun',
    'eLEXTYPE_PRIVATE9', 'DISPID_SLGetPronunciations', 'SPWT_DISPLAY',
    'DISPID_SpeechPhraseRule', 'SpeechInterference',
    'SpeechStreamFileMode', 'SP_VISEME_19', 'SGSDisabled',
    'ISpeechPhraseReplacement', 'SPAS_STOP', 'SVP_21',
    'DISPID_SOTDisplayUI', 'SPPHRASEREPLACEMENT',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPVPRIORITY',
    'DISPID_SRGDictationLoad', 'DISPID_SpeechCustomStream',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SGRsAdd',
    'SpeechFormatType', 'STCAll', 'DISPID_SRCEventInterests',
    'SVEPrivate', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVP_20',
    'ISpeechRecognizer', 'DISPID_SVESentenceBoundary',
    'SDA_One_Trailing_Space', 'SAFTCCITT_ALaw_8kHzStereo',
    'ISpStreamFormat', 'SWPKnownWordPronounceable',
    'ISpeechPhraseAlternates', 'SPRS_ACTIVE', 'DISPID_SRCPause',
    'DISPID_SpeechPhraseRules', 'SECLowConfidence',
    'SPEVENTSOURCEINFO', 'eLEXTYPE_RESERVED7', 'SVP_1',
    'SpeechVoiceEvents', 'DISPID_SpeechAudioBufferInfo', 'SVP_15',
    'SpVoice', 'eLEXTYPE_PRIVATE5', 'DISPIDSPTSI_SelectionOffset',
    'SPGRAMMARSTATE', 'SVEPhoneme', 'DISPID_SOTId',
    'DISPID_SASNonBlockingIO', 'DISPID_SRCEStartStream',
    'SpeechCategoryRecognizers', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPRuleName', 'SAFTDefault',
    'ISpPhoneticAlphabetSelection', 'SPEI_RECO_STATE_CHANGE',
    'ISpRecoCategory', 'DISPID_SPPName', 'ISpeechPhraseProperties',
    'DISPID_SGRSTNextState', 'SRCS_Enabled', 'SPAS_RUN',
    'SpeechCategoryAppLexicons', 'SREBookmark', 'SPAUDIOSTATE',
    'DISPID_SRCEEndStream', 'DISPID_SpeechPhraseReplacements',
    'SVEAudioLevel', 'SP_VISEME_15', 'SVP_5',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPELexicalForm',
    'SDKLCurrentConfig', 'SRADynamic', 'SpeechGrammarTagWildcard',
    'DISPID_SRGCmdSetRuleIdState', 'SpPhoneticAlphabetConverter',
    'SAFT24kHz16BitMono', 'DISPID_SpeechAudio', 'SITooFast',
    'SRAInterpreter', 'SPRST_ACTIVE_ALWAYS', 'SECFDefault',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SpeechLexiconWords',
    'SP_VISEME_20', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SVAudioOutput', 'SPSMF_UPS', 'SAFT16kHz8BitMono',
    'DISPID_SGRsItem', 'DISPID_SpeechLexiconPronunciation',
    'ISpeechPhraseElement', 'ISpeechBaseStream', 'DISPID_SBSWrite',
    'SPGS_DISABLED', 'DISPID_SpeechBaseStream', 'SpStream',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPAStartElementInResult',
    'SPWORDTYPE', 'SPXRO_Alternates_SML', 'DISPID_SLWsItem',
    'DISPID_SRStatus', 'SPSEMANTICFORMAT', 'DISPID_SVAlertBoundary',
    'ISpeechObjectTokens', 'SpLexicon', 'SpeechMicTraining',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SVSpeak',
    'SPCS_DISABLED', 'DISPID_SPRsItem', 'DISPID_SGRsFindRule',
    'SPWORDPRONOUNCEABLE', 'STCLocalServer', 'SP_VISEME_10',
    'DISPID_SRRDiscardResultInfo', 'ISpNotifyTranslator',
    'DISPID_SPIRetainedSizeBytes', 'ISpObjectWithToken',
    'eLEXTYPE_PRIVATE10', 'STCInprocServer',
    'DISPID_SGRSAddRuleTransition', 'SpeechGrammarState',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SVResume',
    'SPCT_SUB_DICTATION', 'DISPID_SOTCGetDataKey',
    'ISpeechMemoryStream', 'DISPID_SRGId',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_RESERVED5', 'SpeechStreamSeekPositionType',
    'DISPID_SPRFirstElement', 'SpInProcRecoContext',
    'SVSFPurgeBeforeSpeak', 'SPSInterjection', 'SPBO_TIME_UNITS',
    'SRSEIsSpeaking', 'ISpeechMMSysAudio', 'DISPID_SVVolume',
    'SPPS_Noun', 'SPFM_NUM_MODES', 'DISPID_SPPs_NewEnum',
    'SPRECOSTATE', 'SPPS_Verb', 'SDTProperty', 'SpeechRuleAttributes',
    'STSF_FlagCreate', 'SpeechVoiceSpeakFlags', 'DISPID_SLPsItem',
    'SpeechGrammarTagDictation', 'SP_VISEME_9', 'DISPID_SFSClose',
    'SRAExport', 'SPSHORTCUTPAIRLIST', 'DISPID_SRGCmdLoadFromObject',
    'SpeechDiscardType', 'SAFTGSM610_22kHzMono',
    'SpStreamFormatConverter', 'ISpPhrase', 'DISPID_SLWs_NewEnum',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechPhraseProperties',
    'SpMemoryStream', 'DISPID_SRRTLength', 'SPSTREAMFORMATTYPE',
    'SVP_10', 'DISPID_SPILanguageId', 'SPLOADOPTIONS',
    'ISpeechLexiconWords', 'DISPID_SASState',
    'SpeechAudioFormatGUIDWave', 'DISPID_SRRTimes',
    'ISpPhoneticAlphabetConverter', 'DISPID_SWFEFormatTag',
    'DISPID_SLGenerationId', 'DISPID_SOTs_NewEnum', 'SPSNotOverriden',
    'eLEXTYPE_PRIVATE17', 'SPSHT_EMAIL', 'SREInterference',
    'SpeechCategoryAudioIn', 'SAFT11kHz16BitStereo', 'SPEI_RESERVED3',
    'SpeechRuleState', 'SPFM_CREATE', 'DISPID_SPEAudioTimeOffset',
    'SPEI_TTS_AUDIO_LEVEL', 'SPINTERFERENCE',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPDKL_CurrentConfig',
    'SPEI_TTS_PRIVATE', 'SECFIgnoreKanaType',
    'DISPID_SRCEPropertyNumberChange', 'ISpeechPhoneConverter',
    'DISPID_SDKEnumKeys', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SP_VISEME_14', 'DISPID_SDKGetlongValue', 'ISpeechDataKey',
    'SpInprocRecognizer', 'DISPID_SGRSTPropertyName',
    'SpPhraseInfoBuilder', 'SGRSTTWildcard', 'DISPID_SVEAudioLevel',
    'SAFTADPCM_22kHzStereo', '__MIDL_IWinTypes_0009',
    'SpeechTokenValueCLSID', 'DISPID_SVEViseme',
    'DISPID_SWFEChannels', 'DISPID_SAFGuid', 'DISPID_SRCEPhraseStart',
    'DISPID_SRSetPropertyString', 'SDA_Consume_Leading_Spaces',
    'SPEI_START_INPUT_STREAM', 'SpAudioFormat', 'SPPHRASEPROPERTY',
    'SVP_16', 'DISPID_SLGetWords', 'DISPID_SRRecognizer',
    'SP_VISEME_0', 'SVSFIsFilename', 'DISPID_SPIEnginePrivateData',
    'SVSFNLPMask', 'SREStateChange', 'SPRST_INACTIVE',
    'SPEI_VOICE_CHANGE', 'SECHighConfidence', 'ISpeechPhraseInfo',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SADefaultFormat',
    'DISPID_SASFreeBufferSpace', 'DISPID_SWFESamplesPerSec',
    'SVSFIsXML', 'IInternetSecurityMgrSite', 'SPRST_ACTIVE',
    'DISPID_SPPEngineConfidence', 'DISPID_SLWPronunciations',
    'SPAUDIOSTATUS', 'ISpeechRecoResultDispatch', 'SAFT48kHz8BitMono',
    'SRSInactive', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRCBookmark', 'tagSPPROPERTYINFO', 'DISPID_SGRs_NewEnum',
    'eLEXTYPE_USER_SHORTCUT', 'SPVPRI_NORMAL', 'SPEI_RESERVED2',
    'DISPID_SPEsItem', 'SPPS_Unknown', 'DISPIDSPTSI_ActiveOffset',
    'ISpeechGrammarRule', 'SDA_No_Trailing_Space',
    'DISPID_SVEEnginePrivate', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPIAudioSizeTime',
    'SAFT44kHz8BitStereo', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SRIsShared', 'SVSFParseAutodetect', 'SPFILEMODE',
    'DISPID_SGRSTWeight', 'ISpeechRecognizerStatus',
    'ISpObjectTokenCategory', 'SRTExtendableParse', 'SRAONone',
    'ISpeechPhraseAlternate', 'SGDSActiveWithAutoPause',
    'eLEXTYPE_PRIVATE2', 'SAFTGSM610_8kHzMono',
    'SPEI_END_INPUT_STREAM', 'SAFT48kHz16BitMono', 'STSF_AppData',
    'IEnumString', 'STSF_CommonAppData', 'SRCS_Disabled',
    'SRERecognition', 'DISPID_SRRAudio', 'SVP_18',
    'DISPID_SpeechAudioStatus', 'SPRS_INACTIVE', 'DISPID_SGRSTType',
    'SpeechWordPronounceable', 'DISPID_SRCAudioInInterferenceStatus',
    'SPFM_OPEN_READONLY', 'DISPID_SRAudioInputStream',
    'SPEI_SR_AUDIO_LEVEL', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechVoicePriority', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SPRuleConfidence', 'SPWORD', 'DISPID_SpeechAudioFormat',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRGetFormat', 'SPBINARYGRAMMAR',
    'DISPID_SPRuleChildren', 'DISPID_SpeechDataKey', 'SDTAlternates',
    'DISPID_SRRAudioFormat', 'eLEXTYPE_RESERVED6', 'SGPronounciation',
    'eLEXTYPE_PRIVATE16', 'SpeechAudioState',
    'DISPID_SRCCmdMaxAlternates', 'IEnumSpObjectTokens',
    'SpeechWordType', 'DISPID_SpeechMemoryStream', 'SGRSTTWord',
    'DISPID_SVSkip', 'ISpRecognizer2', 'SRERecoOtherContext',
    'SWPUnknownWordPronounceable', 'SPCT_DICTATION',
    'DISPID_SMSSetData', 'DISPID_SpeechMMSysAudio',
    'SGRSTTTextBuffer', 'SpeechPropertyAdaptationOn',
    'Speech_Max_Pron_Length', 'SAFT16kHz16BitMono',
    'SAFT11kHz8BitMono', 'ISpEventSink', 'SPINTERFERENCE_TOOQUIET',
    'ISpResourceManager', 'SVP_14', 'SAFT44kHz8BitMono',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SOTCDefault',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SSTTTextBuffer',
    'SAFTText', 'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SOTCSetId',
    'eWORDTYPE_DELETED', 'ISpGrammarBuilder',
    'DISPID_SRCEFalseRecognition', 'SPEI_MIN_SR', 'SPVPRI_ALERT',
    'SPEI_PHRASE_START', 'SVSFParseMask', 'SGRSTTEpsilon',
    'SPSHT_OTHER', 'eLEXTYPE_PRIVATE7', 'SPSSuppressWord',
    'DISPID_SRGDictationUnload', 'ISpeechRecoContext', 'SP_VISEME_21',
    'SPPS_Interjection', 'SPPS_SuppressWord', 'SPCS_ENABLED',
    'DISPID_SVSPhonemeId', 'SAFT24kHz8BitStereo', 'ISpeechLexicon',
    'DISPID_SPIEngineId', 'SpSharedRecognizer',
    'SpeechRetainedAudioOptions', 'WAVEFORMATEX',
    'DISPID_SLPs_NewEnum', 'eLEXTYPE_PRIVATE20', 'eLEXTYPE_RESERVED8',
    'DISPID_SWFEBitsPerSample', 'SpeechPartOfSpeech',
    'DISPID_SLPType', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SVEBookmark', 'DISPID_SpeechRecoContext', 'SP_VISEME_17',
    'SpeechRecoContextState', 'DISPID_SWFEAvgBytesPerSec',
    'SAFT8kHz16BitStereo', 'SDTDisplayText',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRRGetXMLResult',
    'DISPID_SGRSAddWordTransition', 'DISPID_SGRSTRule',
    'SVSFIsNotXML', 'SAFT24kHz8BitMono',
    'DISPID_SpeechRecoContextEvents', 'SPLO_STATIC',
    'DISPID_SABIMinNotification', 'SSSPTRelativeToStart',
    'SpTextSelectionInformation', 'SWTAdded',
    'SPRST_INACTIVE_WITH_PURGE', 'eLEXTYPE_PRIVATE6', 'tagSTATSTG',
    'SPADAPTATIONRELEVANCE', 'DISPID_SDKDeleteValue',
    'ISpeechVoiceStatus', 'DISPID_SPPChildren', 'ISpeechAudioFormat',
    'DISPID_SRSAudioStatus', 'SPRECOGNIZERSTATUS', 'SPGS_EXCLUSIVE',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRSClsidEngine', 'SRTAutopause',
    'SpUnCompressedLexicon', 'SPVPRI_OVER', 'eLEXTYPE_PRIVATE12',
    'SRTReSent', 'DISPID_SLWWord', 'DISPID_SpeechObjectToken',
    'DISPID_SRSetPropertyNumber', 'eLEXTYPE_RESERVED9',
    'SPBOOKMARKOPTIONS', 'SPCONTEXTSTATE', 'SPSHORTCUTPAIR',
    'SPEI_RECOGNITION', 'SVSFDefault', 'DISPID_SLPLangId',
    'DISPID_SPAsCount', 'SVF_Stressed', 'DISPID_SVEventInterests',
    'eWORDTYPE_ADDED', 'SPAR_High', 'DISPID_SGRAddResource',
    'ISpEventSource', 'DISPID_SOTCId', 'SVP_3', 'SPEI_RESERVED6',
    'DISPID_SMSALineId', '_ISpeechRecoContextEvents',
    'DISPID_SPAs_NewEnum', 'SPSVerb', 'eLEXTYPE_RESERVED10',
    'DISPID_SPIGrammarId', 'DISPID_SRRGetXMLErrorInfo', 'SPXRO_SML',
    'ISpeechPhraseInfoBuilder', 'SPEI_RESERVED1', 'SPAO_RETAIN_AUDIO',
    'SP_VISEME_5', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SRGSetTextSelection', 'DISPID_SGRAddState', 'SPAO_NONE',
    'DISPID_SGRsDynamic', 'ISpPhraseAlt', 'SPRST_NUM_STATES',
    'DISPID_SRRSpeakAudio', 'SP_VISEME_2', 'ISpStream',
    'DISPID_SRCEHypothesis', 'SVSFParseSapi', 'SDKLDefaultLocation',
    'DISPID_SRCEBookmark', 'DISPID_SVSVisemeId',
    'DISPID_SVSyncronousSpeakTimeout', 'SpeechGrammarWordType',
    'SP_VISEME_8', 'SRSEDone', 'DISPID_SPRuleParent',
    'DISPID_SPCPhoneToId', 'SPPS_RESERVED4', 'DISPID_SRCEAudioLevel',
    'SVSFPersistXML', 'SPPARTOFSPEECH', 'ISpeechGrammarRules',
    'IInternetSecurityManager', 'SP_VISEME_4', 'SAFTADPCM_11kHzMono',
    'SVP_6', 'DISPID_SLWsCount', 'DISPID_SPEs_NewEnum',
    'SGSExclusive', 'DISPID_SPIGetText',
    'SpeechPropertyHighConfidenceThreshold', 'ISpRecoGrammar',
    'DISPID_SGRName', 'ISpRecoGrammar2', 'SAFT8kHz8BitStereo',
    'eLEXTYPE_PRIVATE19', 'DISPID_SDKCreateKey',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPPsCount',
    'ISpNotifySource', 'SpeechBookmarkOptions', 'SAFT32kHz8BitStereo',
    'SDTAll', 'SPSNoun', 'DISPID_SGRInitialState',
    'DISPID_SRGDictationSetState', 'DISPID_SGRSTransitions',
    'SAFT8kHz16BitMono', 'DISPID_SAStatus', 'SVP_13',
    'ISpeechGrammarRuleState', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRCEAdaptation', 'SPPS_Modifier', 'DISPID_SLWLangId',
    'STCInprocHandler', 'SPINTERFERENCE_NOISE', 'SPWORDLIST',
    'SpeechAudioProperties', 'SREHypothesis', 'SPEI_SOUND_START',
    'SREStreamStart', 'SSTTWildcard', 'DISPID_SPIProperties',
    'DISPID_SABIEventBias', 'SAFT16kHz16BitStereo', 'SVEAllEvents',
    'DISPID_SRCERequestUI', 'DISPID_SVEWord', 'SpeechUserTraining',
    'DISPID_SPAsItem', 'DISPID_SPPConfidence', 'SPDKL_CurrentUser',
    'DISPID_SLWType', 'SAFT32kHz16BitStereo', 'SASStop',
    'SGRSTTDictation', 'SPEI_PROPERTY_NUM_CHANGE', 'SPEI_SOUND_END',
    'DISPID_SRRSaveToMemory', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPWF_SRENGINE', 'DISPID_SPPValue', 'SPEI_PHONEME',
    'DISPID_SLGetGenerationChange', 'DISPID_SRCResume',
    'DISPID_SRCEInterference', 'SpeechRecognizerState',
    'DISPID_SRCRequestedUIType', 'SVF_Emphasis', 'DISPID_SRGState',
    'UINT_PTR', 'DISPID_SGRsCommit', 'SAFT8kHz8BitMono',
    'STCRemoteServer', 'DISPID_SpeechPhraseReplacement',
    'SpeechRegistryUserRoot', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SPIElements', 'DISPID_SOTCEnumerateTokens', 'SPEVENTENUM',
    'DISPID_SVSInputSentenceLength', 'SPFM_OPEN_READWRITE',
    'DISPID_SRCESoundEnd', 'DISPID_SDKSetStringValue',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SpeechObjectTokenCategory',
    'eLEXTYPE_RESERVED4', '_SPAUDIOSTATE', 'SAFT11kHz16BitMono',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVP_12',
    'SAFT22kHz16BitMono', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechLoadOption', 'DISPID_SAFType', 'SRTSMLTimeout',
    'SPAUDIOOPTIONS', 'ISpeechLexiconPronunciations',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SPARecoResult',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SPRulesCount',
    'DISPID_SOTsItem', 'SRTStandard', 'SRSActiveAlways',
    'DISPID_SPIStartTime', 'DISPID_SWFEExtraData',
    'ISpeechRecoGrammar', 'SPSHT_NotOverriden',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPXMLRESULTOPTIONS', 'DISPID_SFSOpen', 'SRSInactiveWithPurge',
    'SPSUnknown', 'DISPID_SRCERecognition', 'SVESentenceBoundary',
    'SPGS_ENABLED', 'SWPUnknownWordUnpronounceable',
    'SPAUDIOBUFFERINFO', 'DISPID_SRGetPropertyNumber',
    'ISpNotifySink', 'SLTUser', 'DISPID_SVDisplayUI',
    'eLEXTYPE_PRIVATE18', 'DISPID_SRAudioInput', 'SpResourceManager',
    'SPSERIALIZEDPHRASE', 'SPPHRASEELEMENT', 'SVEStartInputStream',
    'SVEVoiceChange', 'SVSFUnusedFlags', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SVGetProfiles', 'DISPID_SVSRunningState',
    'SPEI_REQUEST_UI', 'DISPID_SLPPhoneIds', 'SREPropertyNumChange',
    'DISPID_SWFEBlockAlign', 'DISPID_SPEActualConfidence',
    'DISPID_SGRId', 'DISPID_SpeechRecoResult',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SVVoice', 'SLTApp',
    'SAFT44kHz16BitStereo', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SGRSTsItem', 'SpeechAllElements', 'SVP_2',
    'DISPID_SRCreateRecoContext', 'SPDKL_DefaultLocation',
    'DISPID_SPRuleFirstElement', 'eLEXTYPE_PRIVATE4',
    'DISPID_SRCRetainedAudio', 'SAFT48kHz8BitStereo',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SpeechGrammarRules',
    'SAFTExtendedAudioFormat', 'SWTDeleted',
    'DISPID_SRCCreateGrammar', 'SAFT16kHz8BitStereo',
    'DISPID_SPEsCount', 'SINone', 'SPWT_PRONUNCIATION',
    'SpeechAudioVolume', 'SPRECOCONTEXTSTATUS', 'SPEI_SR_BOOKMARK',
    'DISPID_SRDisplayUI', 'SPEI_INTERFERENCE', 'SpWaveFormatEx',
    'DISPID_SRCESoundStart', 'DISPID_SPIAudioStreamPosition',
    'SpeechDisplayAttributes', 'SPSEMANTICERRORINFO', 'SDTAudio',
    'eLEXTYPE_PRIVATE13', 'SpNotifyTranslator', 'SAFTADPCM_22kHzMono',
    'eLEXTYPE_APP', 'SAFT12kHz16BitStereo', 'SITooQuiet',
    'SRERequestUI', 'SVPNormal',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPBO_AHEAD',
    'SpObjectTokenCategory', 'SPAS_PAUSE', 'SP_VISEME_13',
    'DISPID_SVPriority', 'SpeechPropertyResourceUsage',
    'SREPhraseStart', 'DISPID_SOTIsUISupported',
    'DISPID_SPEDisplayText', 'DISPID_SVSpeakStream',
    'DISPID_SRCEEnginePrivate', 'SGDisplay', 'SREStreamEnd',
    'DISPID_SpeechPhraseBuilder',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechPhraseElement', 'SPPS_LMA', 'DISPID_SVEVoiceChange',
    'SPEI_START_SR_STREAM', 'Speech_StreamPos_Asap',
    'DISPID_SDKGetStringValue', 'DISPID_SLPsCount', 'SSTTDictation',
    'SGDSActiveUserDelimited', 'STSF_LocalAppData',
    'SPGRAMMARWORDTYPE', 'SRAORetainAudio', 'SDTRule',
    'DISPID_SRIsUISupported', 'SDKLLocalMachine',
    'SPFM_CREATE_ALWAYS', 'ISpXMLRecoResult', 'SPLO_DYNAMIC',
    'SPSHORTCUTTYPE', 'DISPID_SPRNumberOfElements', 'SPSLMA',
    'DISPID_SVGetAudioInputs', 'DISPID_SOTCategory',
    'ISpSerializeState', 'SpeechVisemeType', 'SpSharedRecoContext',
    'ISpeechPhraseRules', 'ISpeechAudioStatus', 'DISPID_SVEPhoneme',
    'DISPID_SpeechLexiconWord', 'SPPROPERTYINFO', 'SPPS_Function',
    'ISpeechWaveFormatEx', 'SSFMOpenReadWrite', 'SLOStatic',
    'DISPID_SDKGetBinaryValue', 'eLEXTYPE_PRIVATE14',
    'ISpeechPhraseReplacements', 'DISPID_SOTGetDescription',
    'SpeechDataKeyLocation', 'SpFileStream',
    'SGLexicalNoSpecialChars', 'SAFT22kHz8BitMono',
    'Speech_Default_Weight', 'SASPause',
    'DISPID_SRSCurrentStreamPosition', 'SPPS_RESERVED2', 'SBOPause',
    'DISPID_SOTGetStorageFileName', 'SpeechAddRemoveWord',
    'SPDATAKEYLOCATION', 'ISpeechPhraseElements', 'DISPID_SVPause',
    'SFTSREngine', 'SPEI_VISEME', 'SPSFunction', 'SPPS_Noncontent',
    'ISpRecoResult', 'DISPID_SpeechVoiceStatus', 'SSFMCreate',
    'Speech_StreamPos_RealTime', 'SpeechRecoProfileProperties',
    'SpeechCategoryPhoneConverters', 'SAFTCCITT_uLaw_11kHzStereo',
    'ISequentialStream', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpObjectToken', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SpeechVoice',
    'DISPID_SpeechLexiconProns', 'DISPID_SLPPartOfSpeech',
    'SDTLexicalForm', 'SPSMF_SAPI_PROPERTIES', 'SpCustomStream',
    'LONG_PTR', 'SREAllEvents', 'IStream', 'SPPS_RESERVED3',
    'ISpMMSysAudio', 'SVF_None',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SGRSRule',
    'SPINTERFERENCE_NOSIGNAL', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SVWaitUntilDone', 'SRARoot', 'ISpeechPhraseProperty',
    'SAFT22kHz16BitStereo', 'DISPID_SAVolume', 'SPPHRASE',
    'DISPID_SRCEPropertyStringChange', 'SVSFNLPSpeakPunc',
    'SpeechDictationTopicSpelling', 'DISPID_SVSInputWordLength',
    'DISPID_SVStatus', 'SREAudioLevel', 'SPEI_MAX_TTS',
    'DISPID_SRCVoice', 'DISPID_SGRsCommitAndSave',
    'DISPID_SpeechPhoneConverter', 'DISPID_SVSLastBookmark',
    'SRSActive', 'SVP_8', 'ISpeechObjectTokenCategory',
    'DISPID_SDKOpenKey', 'SpeechTokenKeyUI',
    'DISPID_SRGetRecognizers', 'ISpStreamFormatConverter',
    'DISPID_SDKDeleteKey', 'ISpObjectToken', 'SVEEndInputStream',
    'DISPID_SVSInputSentencePosition'
]

_check_version('1.2.0', 1619004316.413263)
